...
This is the project where your face is going to be deep sea fish.
...
Most of the source codes of this project, `DeepSeaDream` are stored in the `deepseadream` directory.
...
`make create-container` creates and launch the deepseadream container.
